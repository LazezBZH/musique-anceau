...
function engraveSequence(e, t, s) {
  ...
  e[0].project &&
    (o = `\n      <div><h3>Projet musical</h3><p>${e[0].project}</p></div>\n    `),
    e[0].notions &&
      (r = `\n      <div><h3>Notions et vocabulaire</h3><p>${e[0].notions.join(
        ", "
      )}</p></div>\n        </div>\n    `),
    e[0].comment &&
  ...
  (displayer.title.innerHTML = `<span>Séquence n°${t}&emsp;-&emsp;</span>${e[0].title}`),
    (displayer.sequence.innerHTML = d);
}
